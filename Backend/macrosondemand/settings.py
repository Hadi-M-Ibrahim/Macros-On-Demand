...
SECRET_KEY = 'django-insecure-(x2@u3gx6kmmtj2#jvi3yvk%)+0)(o=#kn@kt3(-+5o+w*4%%a'
...
ROOT_URLCONF = 'macrosondemand.urls'
...
WSGI_APPLICATION = 'macrosondemand.wsgi.application'
...
# CORS settings
CORS_ORIGIN_ALLOW_ALL = True  # For development - allows any origin to access your API
...
# For Expo to work properly, you might need this too:
CORS_ALLOW_HEADERS = [
    'accept',
    'accept-encoding',
    'authorization',
